...
@interface UITextField (SWIFT_EXTENSION(SwiftValidator))
@property (nonatomic, readonly, copy) NSString * _Nonnull validationText;
@end
...
SWIFT_CLASS("_TtC14SwiftValidator15ValidationError")
