...
@IBDesignable public class GMStepper: UIControl {
    ...
    @IBInspectable public var value: Double = 0 {
        didSet {
            ...
            if value == 0{
                leftButton.setImage(UIImage(named: "arrow_up_gray.png"), for: .normal)
    ...
    @IBInspectable public var rightButtonText: UIImage = UIImage.init(named: "arrow_up.png")!  {
        didSet {
            
            rightButton.setImage(UIImage(named: "arrow_up.png"), for: .normal)
    ...
    @IBInspectable public var limitHitAnimationColor: UIColor = UIColor.clear
    ...
    */
    ...
    @IBInspectable public var leftButton: UIButton = {
        let button = UIButton()
//        button.setTitle(self.leftButtonText, for: .normal)
        button.setImage(UIImage(named: "arrow_up_gray"), for: .normal)
...
//        button.titleLabel?.font = self.buttonsFont
    ...
    @IBInspectable public var rightButton: UIButton = {
        let button = UIButton()
...
//        button.titleLabel?.font = self.buttonsFont
    ...
    public lazy var label: UILabel = {
        ...
        label.textColor = UIColor.gray//self.labelTextColor
    ...
    */
    ...
    func setup() {
//        let ui = UIView(frame: CGRect(x: CGFloat(leftButton.frame.origin.x) + leftButton.frame.size.width, y: 0, width: 8, height: leftButton.frame.size.height))
    ...
    public override func layoutSubviews() {
        ...
        spaceView.frame = CGRect(x: 20, y: 0, width: 100, height: leftButton.frame.size.height)//UIView(frame: CGRect(x: buttonWidth, y: 0, width: 8, height: leftButton.frame.size.height))
...
extension GMStepper {
    func leftButtonTouchDown(button: UIButton) {
        ...
        resetTimer()
        if value == 0{
            leftButton.setImage(UIImage(named: "arrow_up"), for: .normal)
            label.textColor = UIColor(red:0.39, green:0.72, blue:0.24, alpha:1.0)
        }
        if value == maximumValue {
            animateLimitHitIfNeeded()
        } else {
            //delegate.didValueUpdate(value: Int(self.value))
            stepperState = .ShouldIncrease
            animateSlideLeft()
        }
    ...
    func rightButtonTouchDown(button: UIButton) {
        ...
        resetTimer()
        if value == 1{
            leftButton.setImage(UIImage(named: "arrow_up_gray"), for: .normal)
